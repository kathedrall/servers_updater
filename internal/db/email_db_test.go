...
func setupEmailTestDB(t *testing.T) (*BoltDB, func()) {
...
func testSMTPConfig_CRUD(t *testing.T) {
	database, teardown := setupEmailTestDB(t)
	defer teardown()

	_, err := database.GetSMTPConfig()
	if err == nil {
...
func TestRecipients_CRUD(t *testing.T) {
	...
	list, err := database.ListRecipient()
	if err != nil {
